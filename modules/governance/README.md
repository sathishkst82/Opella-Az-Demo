...
Creates custom Azure Policy definitions, groups them into the `Sathish-Governance-Baseline` initiative, and assigns the initiative to an environment resource group.
